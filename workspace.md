...
<div class="page-navigation">
  ...
  <div class="nav-section">
    ...
    <ul>
      <li><strong>View family calendar</strong> → Co-parenting schedule coordination</li>
      <li><strong>Submit feedback</strong> → Google Forms for data collection</li>
      <li><strong>Access shared docs</strong> → Drive-embedded files and folders</li>
      <li><strong>Contact via Gmail</strong> → Direct communication form</li>
      <li><strong>AI assistance</strong> → Gemini integration for protocol help</li>
    </ul>
  </div>
  ...
  <div class="nav-section">
    <h4>⚡ QUICK ACCESS</h4>
    <ul>
      <li><strong><a href="#calendar" style="color: var(--circuit-teal);">Calendar</a></strong> → Family schedule</li>
      <li><strong><a href="#forms" style="color: var(--circuit-teal);">Forms</a></strong> → Data collection</li>
      <li><strong><a href="#sheets" style="color: var(--circuit-teal);">Sheets</a></strong> → Tracker database</li>
      <li><strong><a href="#gemini" style="color: var(--circuit-teal);">Gemini AI</a></strong> → Assistant</li>
    </ul>
  </div>
</div>
...
<div style="background: var(--card-dark); padding: 2rem; border-radius: 12px; border: 2px solid var(--circuit-teal); margin: 2rem 0;">
  ...
  <div style="background: var(--darker-bg); padding: 1.5rem; border-radius: 8px; text-align: center; border: 1px dashed var(--border-gray);">
    <p style="color: var(--text-light); margin: 0;">📅 Calendar embed goes here</p>
...
<div class="quick-jump-grid" style="margin: 2rem 0;">
  <div class="quick-jump-tile" style="background: var(--card-dark); border: 2px solid var(--purple);">
    ...
    <a href="#" id="feedback-form-link" style="color: var(--purple); font-size: 0.85rem;">Setup required →</a>
  </div>
  ...
  <div class="quick-jump-tile" style="background: var(--card-dark); border: 2px solid var(--pink);">
    ...
    <a href="#" id="protocol-rating-link" style="color: var(--pink); font-size: 0.85rem;">Setup required →</a>
  </div>
  ...
  <div class="quick-jump-tile" style="background: var(--card-dark); border: 2px solid var(--orange);">
    ...
    <a href="#" id="weekly-review-link" style="color: var(--orange); font-size: 0.85rem;">Setup required →</a>
  </div>
  ...
  <div class="quick-jump-tile" style="background: var(--card-dark); border: 2px solid var(--circuit-teal);">
    ...
    <a href="#contact" style="color: var(--circuit-teal); font-size: 0.85rem;">Setup below →</a>
  </div>
</div>
...
<div style="background: var(--card-dark); padding: 2rem; border-radius: 12px; border: 2px solid var(--purple); margin: 2rem 0;">
  ...
  <ol>
    ...
    <li>Click "Send" → Link icon → Copy link</li>
...
<div style="background: var(--card-dark); padding: 2rem; border-radius: 12px; border: 2px solid var(--border-gray); margin: 2rem 0;">
  ...
  <ol>
    ...
    <li>Use Apps Script to create web endpoint (Tools → Script editor)</li>
...
<div style="background: var(--card-dark); padding: 2rem; border-radius: 12px; border: 2px solid var(--blue); margin: 2rem 0;">
  ...
  <ol>
    ...
    <li>Click More (⋮) → Open in new window → File → Publish to web (for Sheets/Docs)</li>
    <li>Or: Share → Embed → Copy iframe code</li>
...
<script>
  ...
  function exportToSheets() {
    ...
    if (Object.keys(trackerData).length === 0) {
      ...
      messageEl.textContent = '⚠️ No tracker data found. Complete some protocols first.';
      return;
    }
    ...
    statusDiv.style.display = 'block';
    messageEl.textContent = '✅ Tracker data exported! Upload this CSV to your Google Sheet.';
  }
  ...
  document.getElementById('contact-form').addEventListener('submit', async function(e) {
    ...
    setTimeout(() => {
      messageEl.textContent = '⚠️ Contact form endpoint not configured yet. Set up Formspree or EmailJS.';
    }, 1000);
  });
