---
layout: default
title: Morning Transition Checklist
---

# MORNING TRANSITION CHECKLIST

**Use this checklist daily to execute the Morning Transition Protocol (6:00-7:00 AM).**
...
- [ ] **6:20-6:25 AM** - Close all tabs and apps from yesterday
- [ ] **6:20-6:25 AM** - Open only: Calendar, Google Tasks, primary work app
- [ ] **6:20-6:25 AM** - Set phone to Do Not Disturb
...
- [ ] **6:30-6:35 AM** - Add missing essentials (meals, buffers, breaks)
- [ ] **6:35-6:42 AM** - Open Google Tasks and categorize by urgency
- [ ] **6:35-6:42 AM** - Select 3 Priority Tasks for today
- [ ] **6:35-6:42 AM** - Assign Priority Tasks to specific time blocks
- [ ] **6:35-6:42 AM** - Note first micro-action for each Priority Task
...
- [ ] Only necessary tabs/apps are open
- [ ] I know my first Priority Task
- [ ] I know the first micro-action for that task
- [ ] I have time blocked for this task
- [ ] I feel physically comfortable (temperature, not hungry)

### First Micro-Action (6:50-6:55 AM)
- [ ] **6:50 AM** - Set timer for 5 minutes
- [ ] **6:50-6:55 AM** - Execute ONLY the first micro-action
- [ ] **6:55 AM** - Assess: Do I want to keep going?

### Momentum Lock (6:55-7:00 AM)
