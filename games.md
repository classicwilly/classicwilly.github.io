...
<div style="text-align: center; margin-bottom: 3rem;">
  <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">🎮 <span style="color: var(--yellow);">Stim Station</span></h1>
  <p style="color: var(--text-light); font-size: 1.1rem; margin: 1rem 0 0.5rem;">Neurodivergent-friendly games for when you need to zone out.</p>
  <p style="color: var(--text-light); font-size: 0.95rem; margin: 0.5rem 0 1rem;">No scores. No timers. No pressure.</p>
