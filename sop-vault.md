...
<div style="text-align: center; margin-bottom: 3rem;">
  <h1 style="font-size: 2.5rem; margin-bottom: 0.5rem;">📚 <span style="color: var(--circuit-teal);">The SOP Vault</span></h1>
  <div style="height: 2px; width: 100%; background: var(--circuit-teal); margin-bottom: 1.5rem;"></div>
  <p style="color: var(--text-light); font-size: 1.1rem; margin: 0 0 1rem 0;">Standard Operating Procedures for a neurodivergent life.</p>
